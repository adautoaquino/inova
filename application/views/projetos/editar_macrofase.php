            ...
            <div class=" offset-md-2 col-md-8 text-center" style="padding-bottom:4%">
                <form method="post" action="<?php echo base_url() ?>index.php/projetos/main_pj/editar_macrofase/<?php echo $dados['codmacrofase'] ?>">
                    ...
                    <div class="form row">
                        ...
                        <div class="form-group col-md-4">
                            <input type="date" required name="data_prevista_termino" value="<?= isset($dados) ? $dados['data_prevista_termino'] : "" ?>" required placeholder="dd/mm/aaaa" data-mask="00/00/0000" class="form-control" id="data_prevista_termino">
                        </div>
                        <br>
                    </div>
                    <br>
