  ...
  <body background="../../../../images/fundo_login.png">
    ...
    <div class="container">
        ...
        <div class="row" style="padding-top:2%; padding-bottom:1%">
            <div class="col-md-6 offset-md-3">
                <div class="col-md-6 offset-md-3">
                    <label style="padding-bottom:2%; font-size:medium; text-align:left;"><b>Token</b></label>
        ...
        <div class="row" style="padding-top:1%;">
            <div class="col-md-6 offset-md-3 text-center">
                <button class="btn btn-warning" style="color:white;" type="submit">Validar Token</button>
            </div>
        </div>
        </form>
        <br>
