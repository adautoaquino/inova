        ...
        <div class="row" style="padding-top:5%">
            <div class="col-md-10 offset-md-1">
                <div class="card bg-dark text-white">
                    <div class="card-body">
                        <h3><i>Seção de Gerenciamento</i></h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class=" offset-md-2 col-md-8 text-center" style="padding-bottom:4%">
                <div class="card bg-dark" style="width: 100%;">
                    <ul class="list-group list-group-flush">
                        <a href="../../projetos/main_/" class="list-group-item bg-dark" style="color:white"><b>Criar Planejamento Estratégico</b></a>
                        <a href="../../projetos/main_/" class="list-group-item bg-dark" style="color:white"><b>Visualizar Planejamento</b></a>
                        <a href="../../projetos/main_/" class="list-group-item bg-dark" style="color:white"><b>Visualizar Planejamentos Finalizados</b></a>
                    </ul>
                </div>
            </div>
        </div>
